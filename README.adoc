...
2. Concourse Docker: http://concourse.ci/docker-repository.html[Install Instructions]
...
---
  ...
  - name: gs-rest-service-complete
    memory: 256M
    instances: 1
    path: gs-rest-service-0.1.0.jar
----
...
run:
  path: /bin/bash
  args: 
    - source-code/complete/ci/tasks/package.sh
----
