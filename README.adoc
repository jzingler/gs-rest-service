...
2. Vagrant: http://concourse.ci/vagrant.html[Install Instructions]

3. Fly CLI: http://concourse.ci/hello-world.html[Install Instructions]

4. PCF DEV: https://docs.pivotal.io/pcf-dev/#installing[Install Instructions]
...
3. Init, add, commit, remote, and push code to your GitHub repository created in Step 2:
----
git init
git add .	
...
----
fly -t lite set-pipeline -p gs-rest-service-complete -c ci/pipeline.yml --non-interactive --load-vars-from ci/pipeline_params.yml
----
